...
class RunJobSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["job_run_id", "event_id", "scrap_type", "run_config", "urgent"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RunJobSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RunJobSchema from a dict"""
        if obj is None:
            return None
