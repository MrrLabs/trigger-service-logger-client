...
class ScrapingTimingTimeSeriesBucketSchema(BaseModel):
    ...
    seatgeek: Optional[ScrapingTimingTimeSeriesSampleSchema]
    tixr: Optional[ScrapingTimingTimeSeriesSampleSchema]
    __properties: ClassVar[List[str]] = ["time", "ticketmaster", "vividseats", "evenue", "tickpick", "stubhub", "gotickets", "milb", "mlb", "playhousesquare", "telecharge", "mpv", "etix", "ovationtix", "seatgeek", "tixr"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seatgeek": ScrapingTimingTimeSeriesSampleSchema.from_dict(obj["seatgeek"]) if obj.get("seatgeek") is not None else None,
            "tixr": ScrapingTimingTimeSeriesSampleSchema.from_dict(obj["tixr"]) if obj.get("tixr") is not None else None
        })
        return _obj
