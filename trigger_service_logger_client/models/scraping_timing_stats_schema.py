...
class ScrapingTimingStatsSchema(BaseModel):
    ...
    telecharge: Optional[ScrapingTimingStatsSingleSchema]
    mpv: Optional[ScrapingTimingStatsSingleSchema]
    etix: Optional[ScrapingTimingStatsSingleSchema]
    ovationtix: Optional[ScrapingTimingStatsSingleSchema]
    seatgeek: Optional[ScrapingTimingStatsSingleSchema]
    tixr: Optional[ScrapingTimingStatsSingleSchema]
    __properties: ClassVar[List[str]] = ["ticketmaster", "vividseats", "evenue", "tickpick", "stubhub", "gotickets", "milb", "mlb", "playhousesquare", "telecharge", "mpv", "etix", "ovationtix", "seatgeek", "tixr"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of seatgeek
        if self.seatgeek:
            _dict['seatgeek'] = self.seatgeek.to_dict()
        # override the default output from pydantic by calling `to_dict()` of tixr
        if self.tixr:
            _dict['tixr'] = self.tixr.to_dict()
        ...
        # set to None if seatgeek (nullable) is None
        # and model_fields_set contains the field
        if self.seatgeek is None and "seatgeek" in self.model_fields_set:
            _dict['seatgeek'] = None

        # set to None if tixr (nullable) is None
        # and model_fields_set contains the field
        if self.tixr is None and "tixr" in self.model_fields_set:
            _dict['tixr'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "telecharge": ScrapingTimingStatsSingleSchema.from_dict(obj["telecharge"]) if obj.get("telecharge") is not None else None,
            "mpv": ScrapingTimingStatsSingleSchema.from_dict(obj["mpv"]) if obj.get("mpv") is not None else None,
            "etix": ScrapingTimingStatsSingleSchema.from_dict(obj["etix"]) if obj.get("etix") is not None else None,
            "ovationtix": ScrapingTimingStatsSingleSchema.from_dict(obj["ovationtix"]) if obj.get("ovationtix") is not None else None,
            "seatgeek": ScrapingTimingStatsSingleSchema.from_dict(obj["seatgeek"]) if obj.get("seatgeek") is not None else None,
            "tixr": ScrapingTimingStatsSingleSchema.from_dict(obj["tixr"]) if obj.get("tixr") is not None else None
        })
        return _obj
