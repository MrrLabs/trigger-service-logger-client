...
class FinishDataProcessJobRequestSchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["finished", "success", "process_notes", "error_reason", "retry_reached", "started", "data_process_notes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinishDataProcessJobRequestSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinishDataProcessJobRequestSchema from a dict"""
        if obj is None:
            return None
